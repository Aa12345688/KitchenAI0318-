                        ...
                        <div className="space-y-4">
                            <div className="bg-black/40 rounded-3xl p-6 border border-white/10 space-y-4">
                                <div className="flex justify-between items-center">
                                    <div>
                                        <div className="text-xs font-black text-white uppercase tracking-widest">辨識靈敏度 (Sensitivity)</div>
                                        <div className="text-[8px] font-bold text-gray-500 uppercase mt-1">Adjust Confidence Threshold</div>
                                    </div>
                                ...
                                <div className="flex justify-between mt-1 px-1">
                                    <span className="text-[8px] font-black text-gray-700 uppercase">高精準 (Strict)</span>
                                    <span className="text-[8px] font-black text-gray-700 uppercase">均衡 (Balanced)</span>
                                    <span className="text-[8px] font-black text-gray-700 uppercase">高靈敏 (Sensitive)</span>
                                </div>
                            </div>
