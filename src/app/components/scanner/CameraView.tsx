    ...
    return (
        <div className="flex flex-col items-center w-full max-w-sm">
            <div className="relative w-full">
                ...
                {/* 辨識靈敏度控制 (Elite Sensitivity Slider) */}
                <div className="w-full mt-6 px-1 space-y-3">
                    <div className="flex justify-between items-center px-1">
                        <div className="flex items-center gap-2">
                             <Brain size={12} className="text-primary/70" />
                             <span className="text-[10px] font-black text-white/40 uppercase tracking-[0.15em]">辨識靈敏度 Sensitivity</span>
                        </div>
                        <div className="px-2 py-0.5 rounded-lg bg-primary/10 border border-primary/20">
                            <span className="text-[10px] font-black text-primary">{Math.round((1.0 - (settings?.confidenceThreshold || 0.25)) * 100)}%</span>
                        </div>
                    </div>
                    <div className="group relative h-10 bg-white/5 rounded-2xl border border-white/10 flex items-center px-4 hover:bg-white/10 transition-all">
                        <input 
                            type="range" 
                            min="0.05" 
                            max="0.95" 
                            ...
                            className="w-full h-1.5 bg-white/10 rounded-full appearance-none accent-primary cursor-pointer relative z-10" 
                        />
                    </div>
                    <div className="flex justify-between px-2">
                         <span className="text-[8px] font-black text-gray-700 uppercase">穩定精準</span>
                         <span className="text-[8px] font-black text-gray-700 uppercase">均衡</span>
                         <span className="text-[8px] font-black text-gray-700 uppercase">靈活偵測</span>
                    </div>
                </div>
            </div>
